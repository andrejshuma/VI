...
class Squares(Problem):
    ...
    #     petti_goal = (4,0)
    #
    #     value+= abs(prv[0]-prv_goal[0]) + abs(prv[1]-prv_goal[1])
    #     value+= abs(vtor[0]-vtor_goal[0]) + abs(vtor[1]-vtor_goal[1])
    #     value+= abs(tret[0]-tret_goal[0]) + abs(tret[1]-tret_goal[1])
    #     value+= abs(cet[0]-cetvrt_goal[0]) + abs(cet[1]-cetvrt_goal[1])
    #     value+= abs(pet[0]-petti_goal[0]) + abs(pet[1]-petti_goal[1])
    #
    #     return value
